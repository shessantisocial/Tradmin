...
side_img_data = Image.open("sideimage.jpeg")
email_icon_data = Image.open("emailimage.jpeg")
password_icon_data = Image.open("passwordimage.jpeg")
google_icon_data = Image.open("googleimage.jpeg")
