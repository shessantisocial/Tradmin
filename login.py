...
label1 = CTkLabel(master=frame, text='Welcome Back!', text_color='#601E88', anchor='w', justify='left', font=('Arial Bold', 24))
...
label3 = CTkLabel(master=frame, text='Email:', text_color='#601E88', anchor='w', justify='left', font=('Arial Bold', 14), image=emailimage, compound='left')
label3.pack(anchor='w', pady=(38,0), padx=(25,0))
entry1 = CTkEntry(master=frame, width=225,fg_color='#EEEEEE', border_color='#601E88', border_width=1, text_color='#000000', placeholder_text='glory@gmail.com')
entry1.pack(anchor='w', padx=(25,0))

label4 = CTkLabel(master=frame, text='Password:', text_color='#601E88', anchor='w', justify='left', font=('Arial Bold', 14), image=passimage, compound='left')
label4.pack(anchor='w', pady=(21,0), padx=(25,0))
entry2 = CTkEntry(master=frame, width=225, fg_color='#EEEEEE', border_color='#601E88', border_width=1, text_color='#000000', show='*')
entry2.pack(anchor='w', padx=(25,0))

button1 = CTkButton(master=frame, text='LOGIN', fg_color='#601E88', hover_color='#FFBB00', font=('Arial Bold', 12), text_color='#ffffff', width=225)
button1.pack(anchor='w', pady=(40,0), padx=(25,0))
button2 = CTkButton(master=frame, text='Continue With Google', fg_color='#EEEEEE', hover_color='#EEEEEE', font=('Arial Bold', 9), text_color='#601E88', width=225, image=googleimage)
